...
<div class="slider display-table center-text">
        <h1 class="title display-table-cell"><b>RGISTRATION</b></h1>
    </div><!-- slider -->
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="post-wrapper">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="about" class="form-control{{ $errors->has('about') ? ' is-invalid' : '' }}" name="about" autofocus>{{ old('about') }}</textarea>
